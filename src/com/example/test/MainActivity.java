...
//
//    private final SurfaceHolder.Callback Surfaceview2Callback = new Callback() {
//        @Override
//        public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
...
//
//
//    private final SurfaceHolder.Callback Surfaceview3Callback = new Callback() {
//        @Override
//        public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
...
//    };
//
//   private final SurfaceHolder.Callback Surfaceview4Callback = new Callback() {
//        @Override
//        public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
